...
ob_start(); ?>
    ...
    <form action="index.php?action=editComment&id=<?php echo $comment['id'] ?>" method="post" enctype="multipart/form-data">
        <div class="form-group">
            <label for="title">Identifiant du chapitre correspondant</label>
        ...
        <div class="form-group">
            <label for="postContent">Contenu du commentaire</label>
            <textarea id="postContent" name="content" rows="10"><?php echo $comment['comment']; ?></textarea>
        </div>
        <div class="form-group">
